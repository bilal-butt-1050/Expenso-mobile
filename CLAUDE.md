...
3. **No `any`.** API responses, props and route params are all typed.
...
6. **Scroll containers must clear the elevated tab dock.** Currently done with `paddingBottom: 140`;
   migrating to `useBottomTabBarHeight()`.
